		...
		<nav id="sidebar">
			<div class="p-4 pt-5">
    	        ...
    	        <ul class="list-unstyled components mb-5">
                   ...
                   <li><a href="#" class="text-warning"><i class="fas fa-check-double"></i> Correct Exam</a></li>
        	...
        	<nav class="navbar navbar-expand-lg navbar-light bg-light shadow">
                    	...
                    	<div class="row align-items-center justify-content-center">
                        	<div class="col-md-6 text-center">
                                <div class="card bg-light col-md mt-1" style="border-style: none;">
                                    <div class="card-body">
                                        <h4 class="card-title"><i class="fas fa-check-double"></i> <strong> Correct Exam</strong></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
             ...
             <div class="container mt-5">
                ...
                <table class="table table-bordered table-striped table-hover mb-5">
                    <h4 class="border bg-light text-center">Submited Exams</h4>
                    <thead class="bg-secondary text-white">
                        <tr>
                            ...
                            <th class="text-center bg-dark text-white" scope="col">Result</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>---</td>
                            <td>---</td>
                            <td class="text-center"><a href="t_view_exam_paper.php" class="btn btn-info btn-small text-white">view result</a></td>
                       </tr>
                    </tbody>
