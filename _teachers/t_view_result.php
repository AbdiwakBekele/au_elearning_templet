                        ...
                        <div class="row">
                            <div class="mt-3 mb-3 col-md">
                                <form class="d-flex">
                                    ...
                                    <button class="btn btn-primary text-white" type="submit" style="margin-left: -11px;">Search</button>
                                </form>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md">
                                <div class="row">
                                    <div class="col-md mb-3">
                                        <h4 class="text-center bg-dark text-white"> Overall Result</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-5">
                                        <h4 class="text-center bg-light border">Exam</h4>
                                        <table class="table table-bordered table-striped table-hover">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-5">
                                        <h4 class="text-center bg-light border"> Assignment</h4>
                                        <table class="table table-bordered table-striped table-hover">
                                            <thead class="bg-secondary text-white">
                                                    <th>NO.</th>
                                                    <th>Class</th>
