        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <form class="was-validated p-5 bg-light border shadow the_logo_form" action="home.html" method="post" name="form" onsubmit="return validated()">
                    ...
                    <button type="submit" class="btn-lg btn-success col-sm-12 mt-2">Send</button>

                    <div class="row">
                        <div class="col-md">
                             <p class="mt-3 text-center text-secondary"><strong>Back To Login!<a href="s_signin.html">&nbsp;Click Here</a></strong></p> 
                        </div>
                    </div>
