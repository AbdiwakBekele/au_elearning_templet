...
function dummy(){
    ...
    if(!data_exist("teacher", "email", $_POST["email"]))
        return "Email you've entered does'nt match any account.";
    else{
        if($id = a_match($_POST['email'], $_POST['password'], 'teacher')){
            $_SESSION['teacher_id'] = $id;
            header("Location: _teachers/t_view_result.php");
            exit;
        }
...
<html lang="en-us" dir="ltr">
    <head>
        ...
        <title>AU e-learning - Teachers Signin</title>    
...
<body>
    ...
    <header id="top-header" style="background-color: #dad535;">
        <div class="top-tol">
            <ul>

            <div id="logo">
                <a><img src="images/LogooB2.png"></a>
                <!-- <label id="l1">e-learning</label> -->
            </div>

                <div class="dropdown myac">
                    <a id="a1" class="btn btn-success dropdown-toggle" href="#" role="button" id="dpMLink" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-users"></i>&nbsp;<label>Accounts</label></a>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dpMLink">
                        ...
                        <li class="dropdown-item"><a id="active_page" href="#"><i class="fas fa-chalkboard-teacher"></i> Teachers</a></li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6 p-2 bg-light border text-center">
                    <h1 class="text-secondary"><strong>Teacher Login</strong></h1>
                </div>
             </div>
        </div>
    </section>    
    ...
    <hr>
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <form class="was-validated border p-4 mb-4 bg-light shadow the_logo_form" action="" method="post" name="form" onsubmit="return validated()">
                    ...
                    <div class="row">
                        <div class="col-md">
                            <p class="mt-3 text-center text-secondary"><strong>Forget Password ?<a href="t_sys_gen_pass.html">&nbsp;Click Here</a></strong></p> 
                        </div>
                    </div>
