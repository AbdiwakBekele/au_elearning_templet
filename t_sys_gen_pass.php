        ...
        <div class="top-tol">
            ...
            <div id="logo">
                ...
                <div class="dropdown myac">
                    <a id="a1" class="btn btn-info dropdown-toggle" href="#" role="button" id="dpMLink" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-users"></i>&nbsp;<label>Accounts</label></a>
    ...
    <hr>
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <form class="was-validated border p-4 mb-4 bg-light shadow the_logo_form" action="home.html" method="post" name="form" onsubmit="return validated()">
                    ...
                    <div class="row">
                        <div class="col-md">
                            <p class="mt-3 text-center text-secondary"><strong>Back To Login!<a href="t_signin.html">&nbsp;Click Here</a></strong></p>
                        </div>
                    </div>
