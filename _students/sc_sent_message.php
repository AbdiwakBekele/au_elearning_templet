...
<html lang="en-us" dir="ltr">
    <head>
        ...
        <title>Student | Sent Messsage</title>    
			...
			<div class="p-4 pt-5">
		  	  <a href="#" class="img logo rounded-circle mb-5" style="background-image: url(images/logo.jpg);"></a>
    	           <ul class="list-unstyled components mb-5">
                       ...
                       <li><a href="sc_communication.html" class="text-warning"><i class="fas fa-comments"></i> Communication</a></li>
                    </ul>
            ...
            <section class="p-5">
                <div class="container">
                    <div class="row g-4 mx-0">
                        ...
                        <a href="sc_communication.html" class="col-md-4" style="text-decoration: none;">
                        ...
                        <a href="sc_inbox.html" class="col-md-4" style="text-decoration: none;">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                  <thead>
                                    <tr class="h5 bg-primary text-white">
                                      ...
                                      <th class="text-center" scope="col">Sent To</th>
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>imperuvment</td>
                                        ...
                                        <td>05-16-2022</td>
                                        <td class="text-center h4"><i class='fas fa-address-card'></i></td>
