...
if(isset($_POST['submit'])){
    $id = add_student($_POST['student_id'], $_POST['user_full_name'], $_POST['gender'], $_POST['email'], $_POST['phone']);
    //if($id) //horray
    //else   // woink
}
                            ...
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-6 text-center">
                                    <div class="card bg-light col-md mt-1" style="border-style: none;">
                                        <div class="card-body">
                                            <h4 class="card-title"><i class="fas fa-tachometer-alt"></i> <strong>Add Students</strong></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <a href="#" class="col-md-3" style="text-decoration: none;">
                                <div class="card bg-success text-white">
                                    <div class="card-body">
                                        <h4><i class="fas fa-user-graduate"></i> <b>Students</b> <i class="fas fa-plus"></i></h4>
                                        <hr>
                                        <h5>
                                            <i class="fas fa-users"></i> <b><?php $student_count; ?></b>
                                        </h5>
                                    </div>
                                </div>
                            </a>
   ...
   <div class="col-sm-12 col-md-8 offset-md-2"> 
   		<center>
   			<form class="was-validated bg-light border shadow p-3" method="POST" enctype="multipart/form-data" name="form">
   				...
   				<div class="row mt-3">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="user_full_name" id="fullname" placeholder="Enter Full Name" required>
                    ...
                    <div class="form-group col-md-6">
                        <label for="stud_id" class="form-label"><h6><b><i class="fas fa-user-graduate"></i> Student Id.</b></h6></label>
                        <input type="text" class="form-control" name="student_id" for="stud_id" placeholder="Enter Student Id." maxlength="12" required>
                ...
                <div class="row mt-3">
                    <div class="form-group col-md-6">
                        <label for="phone_no"><h6><b><i class="fas fa-phone"></i> Phone No.</b></h6></label>
                        <input type="phone" class="form-control" name="phone" id="phone_no" placeholder="Enter Your Phone No." required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>  
                    </div>
			...
			<!-- <div class="row mt-3 mb-3">
				<div class="form-group col-md-6">
					<label for="year"><h6><b>Year</b></h6></label>
					<select name="state" class="form-control" id="year">
				...
				<div class="form-group col-md-6">
					<label for="semester"><h6><b>Semester</b></h6></label>
					<select name="state" class="form-control" id="semester">
  						<option selected>Choose...</option>
  						<option value="1st_Year">1st Semester</option>
						<option value="2nd_year">2nd Semester</option>
						<option value="3rd_year">3rd Semester</option>
					</select>
				</div>
			</div> -->
