...
<html lang="en-us" dir="ltr">
  ...
  <body>
                            ...
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-6 text-center">
                                    <div class="card bg-light col-md mt-1" style="border-style: none;">
                                        <div class="card-body">
                                            <h4 class="card-title"><i class="fas fa-tachometer-alt"></i> <strong>Assign Teacher</strong></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <br><br><!-- <center><img src="../images/Logoo.png" class="bg-dark mb-3" width="300px" height="80px" alt=""></center> -->
    <hr>
   ...
   <div class="col-sm-12 col-md-8 offset-md-2"> 
            <form action="" method="POST" class="p-4 bg-light">
                ...
                <div class="row mb-3">
                  <div class="form-group col-md">
                    <label><h6>Select Teacher</h6></label>
                    <form class="d-flex">
                ...
                <div class="col-md mt-3 mb-3">
                    <button type="submit" name="submit" class="btn btn-primary btn-large col-md-12" value="assign_teacher">Assign Teacher</button>
                </div> 
            </div> 
